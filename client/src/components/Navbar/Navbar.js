          ...
          <div className="navbar-div">
            <nav className="navbar">
              ...
              >
                ...
                <Link to="/users" className="motif" title="Go to Users">
                  {" "}
                  <li>Users</li>
                </Link>
                <Link to="/posts" className="motif" title="Go to Posts">
                  {" "}
                  <li>Posts</li>
                </Link>
                <Link
          ...
          <div className="navbar-div">
            <nav className="navbar">
              ...
              >
                ...
                <Link to="/myposts" className="motif" title="Go to My Posts">
                  {" "}
                  <li>My posts</li>
                </Link>
                <Link
                ...
                >
                  {" "}
                  <li>
                    Favorites ({auth.favorites ? auth.favorites.length : 0} x{" "}
